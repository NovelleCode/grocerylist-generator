...
import se.iths.grocerylistgenerator.jwt.JwtAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(UserDetailsService userDetailsService, PasswordEncoder passwordEncoder, JwtConfig jwtConfig, JwtAuthenticationEntryPoint jwtEntryPoint) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .exceptionHandling().authenticationEntryPoint(jwtEntryPoint).accessDeniedHandler(new SimpleAccessDeniedHandler())
                .and()
                .authorizeRequests()
